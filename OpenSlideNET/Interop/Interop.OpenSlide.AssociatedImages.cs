...
public static partial class OpenSlideInterop
{
    ...
    private static extern unsafe IntPtr* GetAssociatedImageNamesInternal(OpenSlideImageSafeHandle osr);
    ...
    public static unsafe string[] GetAssociatedImageNames(OpenSlideImageSafeHandle osr)
    {
        ...
        var pCurrent = GetAssociatedImageNamesInternal(osr);
    ...
    [DllImport(LibOpenSlide, EntryPoint = "openslide_get_associated_image_dimensions", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    private static extern void GetAssociatedImageDimensionsInternal(OpenSlideImageSafeHandle osr, IntPtr name, out long w, out long h);
    ...
    {
        using var utf8Name = new Utf8String(name);
        GetAssociatedImageDimensionsInternal(osr, utf8Name, out w, out h);
    }

    [DllImport(LibOpenSlide, EntryPoint = "openslide_read_associated_image", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
    private static extern unsafe void ReadAssociatedImageInternal(OpenSlideImageSafeHandle osr, IntPtr name, void* dest);
    ...
    {
        using var utf8Name = new Utf8String(name);
        ReadAssociatedImageInternal(osr, utf8Name, dest);
    }
}